...
<header class="py-3 border-b border-slate-200">
    <nav class="flex justify-between items-center">
        ...
        <div class="flex gap-12">
            <a href="/user-settings" class="flex items-center gap-1">
                <img class="max-h-6 h-full" src="{{ asset('icons/settings.png') }}" alt="view user settings">
